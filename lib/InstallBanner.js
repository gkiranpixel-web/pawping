...
const DISMISS_KEY = "pawping-install-dismissed";

// A small, dismissible bar offering to install PawPing as an app.
...
export default function InstallBanner(){
  ...
  return <div className="installBar">
    <span>{deferred?"Install PawPing on this device for quick access.":"Add PawPing to your Home Screen: tap Share, then \"Add to Home Screen.\""}</span>
